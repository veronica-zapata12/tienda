package com.tienda.personas.infraestructura.error;
...
import com.tienda.personas.dominio.excepcion.ExcepcionGeneral;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<com.tienda.personas.infraestructura.error.Error> handleAllExceptions(Exception exception) {
        ResponseEntity<com.tienda.personas.infraestructura.error.Error> resultado;
        ...
        if (codigo != null) {
            com.tienda.personas.infraestructura.error.Error error = new com.tienda.personas.infraestructura.error.Error(excepcionNombre, mensaje);
            resultado = new ResponseEntity<>(error, HttpStatus.valueOf(codigo));
        } else {
            LOGGER.error(excepcionNombre, exception);
            com.tienda.personas.infraestructura.error.Error error = new com.tienda.personas.infraestructura.error.Error(excepcionNombre, OCURRIO_UN_ERROR_FAVOR_CONTACTAR_AL_ADMINISTRADOR);
