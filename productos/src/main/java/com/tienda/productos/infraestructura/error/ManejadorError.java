package com.tienda.productos.infraestructura.error;
...
public class ManejadorError extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<com.tienda.productos.infraestructura.error.Error> handleAllExceptions(Exception exception) {
        ResponseEntity<com.tienda.productos.infraestructura.error.Error> resultado;
        ...
        if (codigo != null) {
            com.tienda.productos.infraestructura.error.Error error = new com.tienda.productos.infraestructura.error.Error(excepcionNombre, mensaje);
            resultado = new ResponseEntity<>(error, HttpStatus.valueOf(codigo));
        } else {
            LOGGER.error(excepcionNombre, exception);
            com.tienda.productos.infraestructura.error.Error error = new com.tienda.productos.infraestructura.error.Error(excepcionNombre, OCURRIO_UN_ERROR_FAVOR_CONTACTAR_AL_ADMINISTRADOR);
